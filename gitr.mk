...
# override this in your terminal
...
gitr-print:
	...
	@echo $(shell echo $(basename `git rev-parse --show-toplevel`) )
...
gitr-fork-catchup:
	@echo
	@echo -- git catchup: Repo: $(GITR_REPO_NAME) --  
	echo '${HELP_GREEN}$(GITR_REPO_NAME)${HELP_RESET}'
	@echo
